"""S-filings (dilution) extraction-quality eval (spec section 14.1).

Run locally:  uv run pytest -m eval tests/evals/test_s_filings_extraction.py -v
...
_SPEC = WORKER_EVALS["s_filings"]


@pytest.fixture(scope="module")
def gold_set() -> GoldSet:
    return load_gold_set(
        _SPEC.gold_path, worker="s_filings", thresholds=_SPEC.default_thresholds
    )
